...
int CHudWatermark::Draw(float time)
{
	...
	char str[256];
	sprintf(str, "^2XGEngine^7: built ^1%s^7, commit ^2%s^7, architecture ^3%s^7, platform ^5%s\n",
		BuildInfo::GetDate(),
	...
	gHUD.DrawHudStringWithColorTags(ScreenWidth / 20, gHUD.m_scrinfo.iCharHeight * 2, "t.me/get_offset", r, g, b);
	gHUD.DrawHudStringWithColorTags(ScreenWidth / 20, gHUD.m_scrinfo.iCharHeight * 3, "Thanks github.com/ElinSrc/Client-Mod for client base", r, g, b);
