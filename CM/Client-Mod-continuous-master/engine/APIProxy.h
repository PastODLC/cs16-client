...
// Include enums.h for netsrc_s enum definition
// Always include for non-MSVC compilers (MinGW, GCC, Clang, etc.)
// MSVC might have this defined elsewhere, but it's safer to include it always
