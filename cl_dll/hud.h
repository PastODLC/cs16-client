...
private:
	...
	cvar_t *m_pCvarKillMessage;  // Kill message enable
	void SendKillMessage(const char *victimName);  // Send kill message to chat
};
...
// CHudCheatMenu removed - using CHudCheatMenuVGUI instead
...
public:
	...
	void CollectPlayerInfo();  // Сбор информации о всех игроках на сервере
	...
	CHudCornerBox	m_CornerBox;
	CHudAimbot		m_Aimbot;
	CHudDebug		m_Debug;
	CHudCheatMenuVGUI m_CheatMenuVGUI;
	CHudPlayerList	m_PlayerList;
